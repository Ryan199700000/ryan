...
ryan = LINETCR.LINE()
#ryan.login(qr=True)
ryan.login(token='Erhf27OaUEnUbNxy4FH5.4U3sY2a2Pdlkd0vcOsmybq.T2x/56NZShLpuxc8McOTqhajhjRrP36Nr78Lko/TM6c=')
ryan.loginResult()
...
Bots=[mid]
Creator=["ue2edd2cb6036a432ca0f4542a1231805"]
admin=["ue2edd2cb6036a432ca0f4542a1231805"]
...
#                            Name = summon(op.param2)
		...
		if msg.from_ in admin:
                    ...
                    wait["kickMention"] = False
                    ryan.sendText(msg.to,"Auto Respon4 Sudah Aktif")
		else:
		    ryan.sendText(msg.to,"Khusus Admin")
		...
		if msg.from_ in admin:
                    wait["detectMention4"] = False
                    ryan.sendText(msg.to,"Auto Respon4 Sudah Off")
		else:
		    ryan.sendText(msg.to,"Khusus Admin")	
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                link = ["https://m.facebook.com/photo.php?fbid=1234947913301750&id=100003596605596&set=a.113252665471286.15384.100003596605596&source=11"]
