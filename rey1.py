...
ryan = LINETCR.LINE()
ryan.login(token='ErcWLM8zivammlYgFpmd.9iTHsnc8pU2ttQcP5O6bBq.C3DOconI98bM+NdN/nmDL8qJII2FzN1p3Mm6fiDf580=')
ryan.loginResult()
...
Bots=[mid]
Creator=["uf48b6148d0bc3eed934ea0a9e68e816d","ua57447862dcfe2ebb3b68be217cb6778"]
admin=["uf48b6148d0bc3eed934ea0a9e68e816d","ua57447862dcfe2ebb3b68be217cb6778"]
...
#			    random.choice(KAK).kickoutFromGroup(op.param1,[op.param2])
	...
	if op.type == 19:
		...
		ryan.sendText(msg.to,"ʜᴀᴅɪʀ!!!")
                ...
                ryan.sendText(msg.to,responsename1)
